    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if(extras != null) {
                ...
                contacts = ds.getContact("contactname", "ASC");
            }
            ds.close();


        } catch (Exception e){
            Toast.makeText(this, "Contacts couldn't be retrieved", Toast.LENGTH_LONG).show();
        }
        ...
        switch (requestCode) {
            ...
            case PERMISSION_REQUEST_CAMERA: {
                if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    //Toast.makeText(ContactActivity.this, "Yuo wont be able to save pictures", Toast.LENGTH_LONG).show();
                }
                return;
            }
        }
