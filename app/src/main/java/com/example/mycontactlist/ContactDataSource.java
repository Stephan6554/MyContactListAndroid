...
public class ContactDataSource {
    ...
    public boolean insertContact(Contact c) {
        ...
        try {
            ...
            initialValues.put("number", c.getHomeNumber());
            initialValues.put("address", c.getStreetAddress());
            ...
            //will return false if exception
        }
        return didSucceed;
    }
    ...
    public ArrayList    <Contact> getContact(String sortField,String sortOrder) {
        ...
        try {
            ...
            while (!cursor.isAfterLast()) {
                ...
                newContact.setCity(cursor.getString(4));
                newContact.setState(cursor.getString(5));
                newContact.setZipCode(cursor.getString(6));
                newContact.setHomeNumber(cursor.getString(3));
